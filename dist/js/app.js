...
// --------------------------------------------- //
// Color Switch Start (patched for React)
// --------------------------------------------- //
...
// Expose on window so React's App.jsx can call them after render
window.initThemeSwitcher = initThemeSwitcher;
window.loadTheme = loadTheme;
window.getCurrentTheme = getCurrentTheme;

// Run immediately if DOM already has the button (React already rendered),
// otherwise wait for DOMContentLoaded
if (document.querySelector('.color-switcher')) {
  initThemeSwitcher();
} else {
